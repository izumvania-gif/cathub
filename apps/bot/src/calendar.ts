...
/**
 * Internal HTTP server (127.0.0.1 only) that builds a household's .ics feed with packages/core.
 * PocketBase proxies GET /api/cathub/calendar/{token} here after checking the secret token.
 */
