...
> **Статус: вариант не выбран** (25.09.2026): для хобби-проекта слишком много сложностей. Выбрана Amvera
> со встроенным прокси к Telegram API (см. [PLAN.md](PLAN.md) §8). Документ оставлен как исследование:
> §1 (почему из российских ДЦ не достучаться до Telegram) и §3 (как устроить свой relay) — это
> **запасной план**, если встроенный прокси Amvera перестанет работать.
