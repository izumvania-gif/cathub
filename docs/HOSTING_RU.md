...
> **Решение (25.09.2026):** выбрана Amvera, регион «Москва», со встроенным прокси к Telegram API.
> Как это устроено и как деплоить, см. [DEPLOY_AMVERA.md](DEPLOY_AMVERA.md). Отклонённый вариант
> Yandex Cloud с собственным relay описан в [DEPLOY_YC.md](DEPLOY_YC.md). Ниже — исходный обзор рынка.
